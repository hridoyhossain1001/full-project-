...
});`,w=`<script src="${v}/t.js?key=${k||"YOUR_PUBLIC_TRACKER_KEY"}" defer><\/script>`,j=`// 1. Identify User (before firing events, e.g. on checkout, login, or registration)
capi('setUser', {
